...
<style scoped>
.auth-page { flex: 1; overflow-y: auto; display: grid; place-items: center; padding: 48px 20px; background: linear-gradient(135deg, var(--bg3) 0%, var(--bg2) 52%, var(--bg) 100%); }
.auth-card { width: min(100%, 430px); padding: 36px; border: 1px solid var(--border); border-radius: 18px; background: var(--cream); box-shadow: 0 20px 50px rgba(15, 23, 42, 0.08); }
...
.field input { width: 100%; padding: 12px 13px; border: 1px solid var(--border); border-radius: 9px; background: var(--bg2); color: var(--text1); outline: none; font-size: 14px; }
...
.error-message { padding: 10px 12px; border-radius: 7px; background: var(--error-bg); color: var(--error); font-size: 12.5px; line-height: 1.5; }
